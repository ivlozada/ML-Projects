...
mcp_save = ModelCheckpoint('../../Models/NN_Models/Trained-Model-UO-' + current_time, save_best_only=True, monitor='val_loss', mode='min')
...
model.add(tf.keras.layers.Dense(10, activation=tf.nn.relu6))
